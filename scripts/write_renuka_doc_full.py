...
| "Worker found sleeping in truck." | Rest | Fatigue | Sleeping on job | Supervision | NO | MEDIUM |
| "Crane lifted load over busy walkway." | Lifting | Suspended Load | Lifted over pedestrians | Lift Plan | YES | CRITICAL |
| "H2S monitor alarmed, worker continued working." | Maintenance | Toxic Gas | Ignored alarm | Gas Monitoring | YES | CRITICAL |
| "Loose tools left on top tier of scaffold." | Scaffolding | Dropped Object | Unsecured tools | Housekeeping | YES | HIGH |
| "Papercut from printer." | Office | Sharp object | N/A | N/A | NO | LOW |
| "Driver reversed truck without a spotter." | Logistics | Vehicle | No spotter | Spotter | YES | CRITICAL |
| "Puddle of oil on the rig floor." | Drilling | Slip | Oil spill | Containment | NO | LOW |
| "Started pump while mechanic was still checking alignment." | Maintenance | Mechanical | Unexpected startup | LOTO | YES | CRITICAL |
| "Missing fire extinguisher at hot work site." | Hot work | Fire | Missing equipment | Hot work permit | YES | HIGH |
| "Unsecured ladder slipped, worker fell 3 ft." | Access | Height | Unsecured ladder | Ladder safety | NO | MEDIUM |
| "Entered excavation without shoring." | Digging | Trench collapse | Unshored entry | Shoring | YES | CRITICAL |
| "Safety glasses worn on forehead while grinding." | Grinding | Mechanical | Improper PPE | PPE compliance | NO | MEDIUM |
| "Bypassed door interlock to speed up machine." | Operation | Mechanical | Bypassed safety | Machine guarding | YES | CRITICAL |
| "Found frayed extension cord in puddle." | Maintenance | Electrical | Damaged equipment | Inspection | YES | HIGH |
| "Smelled gas near compressor, did not report." | Operation | Gas release | Failure to report | Gas detection | YES | HIGH |
| "Worker used a bucket as a step stool." | Access | Height | Makeshift elevation | Proper access | NO | MEDIUM |
| "Dropped a heavy wrench from the derrick." | Drilling | Dropped object | Dropped tool | Tool securing | YES | CRITICAL |
| "Opened wrong valve, released hot steam." | Operation | Pressure | Incorrect valve | Procedure | YES | CRITICAL |
| "Not wearing gloves while handling rough lumber." | Carpentry | Splinters | No gloves | PPE compliance | NO | LOW |
| "Tied fall arrest lanyard to a weak pipe." | Maintenance | Height | Improper anchor | Anchor selection | YES | CRITICAL |
| "Confined space hole watch was looking at phone." | Confined Space | Asphyxiation | Distracted standby | Hole watch | YES | HIGH |
